...
for file in manifest.json qmldir AgentFeedState.qml AgentFeedPresentation.js AgentFeedKeyCatcher.qml KeybindingsOverlay.qml NotesOverlay.qml BindingsOverlay.qml BarWidget.qml Panel.qml README.md; do
